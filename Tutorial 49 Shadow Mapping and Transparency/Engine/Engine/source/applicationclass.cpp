...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_GroundModel->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/floor/plane01.txt", "../Engine/data/floor/dirt.tga", 1.0f);
	if(!result)
	{
	...
	result = m_Tree->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/trees/trunk001.txt", "../Engine/data/trees/trunk001.tga", "../Engine/data/trees/leaf001.txt", "../Engine/data/trees/leaf001.tga", 0.10f);
	if(!result)
	{
